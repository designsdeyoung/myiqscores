...
const countrySlugs = [
  ...
  // New countries
  "ukraine", "denmark", "romania", "croatia", "bulgaria", "serbia", "slovakia",
  "iceland", "latvia", "lithuania", "estonia", "belarus", "moldova", "georgia",
  "armenia", "azerbaijan", "kazakhstan", "mongolia", "nepal", "sri-lanka",
  "bangladesh", "myanmar", "cambodia", "jordan", "lebanon", "kuwait", "qatar",
  "bahrain", "oman", "morocco", "algeria", "tunisia", "tanzania", "uganda",
  "ivory-coast", "senegal", "cameroon", "zambia", "bolivia", "ecuador", "peru",
  "chile", "venezuela", "cuba", "jamaica",
];
