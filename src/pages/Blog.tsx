...
const posts = [
  ...
  { slug: "dunning-kruger-effect", category: "Research", categoryColor: "#F59E0B", title: "The Dunning-Kruger Effect Is More Nuanced Than the Meme", excerpt: "The original 1999 Kruger & Dunning study measured metacognitive incompetence — not the viral meme version. Here's what the research actually found.", readTime: "10 min read", date: "May 20, 2026" },
  { slug: "iq-and-age", category: "Science", categoryColor: "hsl(var(--primary))", title: "What Actually Happens to Your IQ Between Age 20 and 70", excerpt: "Fluid intelligence peaks in your mid-20s. Crystallized intelligence peaks in your 60s. The Seattle Longitudinal Study and MIT research reveal a more nuanced picture of cognitive aging.", readTime: "11 min read", date: "May 27, 2026" },
  { slug: "twice-exceptional-adhd-high-iq", category: "Science", categoryColor: "hsl(var(--primary))", title: "Twice-Exceptional: When ADHD and High IQ Coexist", excerpt: "High IQ can mask ADHD while ADHD masks giftedness. Here's what research on twice-exceptional students reveals about diagnosis, assessment, and what parents and educators can do.", readTime: "10 min read", date: "June 3, 2026" },
  { slug: "poverty-and-iq", category: "Research", categoryColor: "#F59E0B", title: "Poverty Doesn't Just Correlate With Low IQ — It Causes It", excerpt: "Financial stress consumes ~13 IQ points of working memory. Early childhood poverty reshapes brain development. The scarcity research is among the most important findings in cognitive science.", readTime: "10 min read", date: "June 10, 2026" },
];
